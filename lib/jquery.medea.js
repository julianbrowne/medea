...
window.Medea = (function($) { 
    ...
    function buttons(element) { 
        ...
        subContainer.append(button("warning").html("cancel").on("click", function(e) { 
            e.preventDefault();
            $(element).trigger("cancel", [ form2object($(element).find(".medea-root")) ]);
            $(element).empty();
        }));
    ...
    $.fn.medea = function(object, opts) { 
        ...
        return this.each(function(index, element) { 
            ...
            if(formElement.length === 0) { formElement = container.closest("form"); }
            ...
            if(formElement.length === 0) { 
                ...
                formElement.on("submit", function(e) { 
                    e.preventDefault();
                    container.trigger("submit.medea.form", [ form2object($(element).find(".medea-root")) ]);
